...
void SceneManager::setupScene()
{
	...
	objects.push_back(obj); //adiciona o background

	//house
	obj = new Sprite;
	obj->setPosition(glm::vec3(150.0f, 175.0f, 0.0));
	obj->setDimension(glm::vec3(300.0f, 300.0f, 1.0f));
	obj->setShader(shader);
	objects.push_back(obj); //adiciona a casa
							
	//personagem
	obj = new Sprite;
	obj->setPosition(glm::vec3(375.0f, 75.0f, 0.0));
	obj->setDimension(glm::vec3(100.0f, 150.0f, 1.0f));
	obj->setShader(shader);
	objects.push_back(obj); //adiciona o personagem

	//spider-man
	obj = new Sprite;
	obj->setPosition(glm::vec3(570.0f, 380.0f, 0.0));
	obj->setDimension(glm::vec3(500.0f, 500.0f, 1.0f));
	obj->setShader(shader);
	objects.push_back(obj); //adiciona o spider
	...
	unsigned int texID = loadTexture("background.png");
	objects[0]->setTexture(texID);
	texID = loadTexture("character.png");
	objects[2]->setTexture(texID);
	texID = loadTexture("spider.png");
	objects[3]->setTexture(texID);
	texID = loadTexture("house.png");
