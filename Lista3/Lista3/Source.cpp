...
void drawCall(GLint rasterCodeLoc, Shader shader, GLuint VAO);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 modelRotate = glm::mat4(1);
		glm::mat4 modelTranslate = glm::mat4(1);
		...
		//Model transformação
		modelRotate = glm::rotate(modelRotate, (GLfloat)glfwGetTime(), glm::vec3(0.0f, 0.0f, 1.0f));
		modelTranslate = glm::translate(modelTranslate, glm::vec3(0.0f, 0.0f, 0.0f));
		modelScale = glm::scale(modelScale, glm::vec3(0.2f, 0.2f, 1.0f));
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(modelRotate));
		drawCall(rasterCodeLoc, shader, VAO);

		glViewport(0, 300, 400, 300);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(modelTranslate));
		drawCall(rasterCodeLoc, shader, VAO);

		glViewport(400, 300, 400, 300);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(modelScale));
		drawCall(rasterCodeLoc, shader, VAO);
