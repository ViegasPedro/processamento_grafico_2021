...
void SceneManager::initializeGraphics()
{
	...
	addShader("binarizacao.vs", "binarizacao.frag");
	addShader("colorizacao.vs", "colorizacao.frag");
	addShader("grayscale.vs", "grayscale.frag");
	addShader("inversao.vs", "inversao.frag");
...
void SceneManager::setupScene()
{
	...
	obj = new Sprite;
	obj->setPosition(glm::vec3(650.0f, 70.0f, 0.0));
	obj->setDimension(glm::vec3(200.0f, 100.0f, 1.0f));
	...
	unsigned int texID = loadTexture("lena.jpg");
