...
int main()
{
    ...
    GLuint VAOexer3a = setupGeometry3a();
    GLuint VAOexer3b = setupGeometry3b();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render the triangle
        glBindVertexArray(VAOexer3a);
        glDrawArrays(GL_TRIANGLES, 0, 3);


        glBindVertexArray(VAOexer3b);
        glDrawArrays(GL_TRIANGLES, 0, 3);
    ...
    // ------------------------------------------------------------------------
    glDeleteVertexArrays(1, &VAOexer3a);
