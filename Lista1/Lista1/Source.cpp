...
int setupShader();
int setupGeometry();
int setupGeometryExercicio1();
void whileOriginal(GLuint shaderID, GLuint VAO, GLint colorLoc);
void whileExercicio1(GLuint shaderID, GLuint VAO, GLint colorLoc);
...
int main()
{
	...
	//glDeleteVertexArrays(1, &VAOexec1);
